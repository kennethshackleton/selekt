...
[![Coverage](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/<GIST_OWNER>/<GIST_ID>/raw/selekt-coverage.json)](https://github.com/bloomberg/selekt/actions/workflows/continuous-integration.yml)
